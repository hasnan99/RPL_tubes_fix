...
public class update_akun_penjual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_akun_penjual);
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id_penjual=id.getText().toString();

                boolean update=db.update_data_penjual(id_penjual,nama_penjual,email_penjual,alamat_penjual,telepon);
                if (update==true){
                    Toast.makeText(update_akun_penjual.this,"Data berhasil di update",Toast.LENGTH_SHORT).show();
